...
def extraer_datos_liquidacion(ruta_archivo):
    # En este caso, si es un PDF, es mejor subirlo primero o convertirlo a imagen
    # Para este ejemplo, asumiremos que Gemini recibe el archivo directamente
    ...
    Extrae todos los campos disponibles y devuélvelos exclusivamente en formato JSON.
